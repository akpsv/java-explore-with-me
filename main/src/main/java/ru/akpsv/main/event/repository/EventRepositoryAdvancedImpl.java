...
public class EventRepositoryAdvancedImpl implements EventRepositoryAdvanced {
    ...
    @Override
    public List<Event> getEventsByAdminParams(EventParams params) {
        CreateCriteriaQuery<Event> cqCreateFunc = (EventParams eventParams, CriteriaBuilder cb, CriteriaQuery<Event> cq, Root<Event> fromEvent) -> {
        ...
        return getEventsByParams(params, cqCreateFunc);
    }
    ...
    private List<Event> getEventsByParams(EventParams params, CreateCriteriaQuery<Event> predicates) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<Event> cq = cb.createQuery(Event.class);
        Root<Event> fromEvent = cq.from(Event.class);

        CriteriaQuery<Event> resultCQ = predicates.getPredicates(params, cb, cq, fromEvent);
...
@FunctionalInterface
interface CreateCriteriaQuery<T> {
    CriteriaQuery<T> getPredicates(EventParams params, CriteriaBuilder cb, CriteriaQuery<T> cq, Root<T> fromEvent);
}
