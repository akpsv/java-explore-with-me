...
public class TestHelper {
    ...
    public static EventFullDto createEventFullDto(CategoryDto categoryDto, UserShortDto userShortDto) {
        ...
        return EventFullDto.builder()
                .id(1L)
                .annotation("annotation")
                .category(new EventFullDto.CategoryDto(categoryDto.getId(), categoryDto.getName()))
                .description("description")
                .createdOn("2024-10-31 17:10:05")
                .eventDate("2024-12-31 17:10:05")
                .publishedOn("2024-12-31 15:10:05")
                .location(new Location(37.617698, 55.755864))
                .initiator(new EventFullDto.UserShortDto(userShortDto.getId(), userShortDto.getName()))
                .paid(false)
                .participantLimit(0L)
                .confirmedRequests(0L)
                .requestModeration(true)
    ...
    public static EventShortDto createEventShortDto(Long id) {
        return EventShortDto.builder()
                ...
                .title("title")
                .views(0L)
                .initiator(new EventShortDto.UserShortDto(1L, "user"))
                .eventDate("2024-12-31 17:10:05")
                .confirmedRequests(0L)
                .annotation("annotation")
                .category(new EventShortDto.CategoryDto(1L, "category"))
                .paid(false)
                .build();
